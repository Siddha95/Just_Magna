...
urlpatterns = [
    ...
    path("dish/delete/<str:pk>", DishDeleteView.as_view(), name="dish-delete"),
    path("dish/update/<str:pk>", DishUpdateView.as_view(), name="dish-update"),
    path("dish/", DishAdminView.as_view(), name="dish-list"),
    path("ingredient/delete/<str:pk>", IngredientDeleteView.as_view(), name="ingredient-delete"),
